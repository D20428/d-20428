...
# [5. 알 수 있는 것 문구 자리]
st.info(f"💡 **이 그래프로 알 수 있는 것:** 개봉 후 시간 경과에 따른 '{selected_movie}'의 관객수증감 추세 및 관객 집중 시기를 확인할 수 있습니다.")

st.markdown("---")

# [5. 구역 나누기] - 구역 2: 추가 그래프를 위한 예시 구역
st.subheader("2. 추가 분석 구역 (예정)")
st.caption("이 구역에 향후 다른 종류의 그래프나 분석 시각화를 추가할 수 있습니다.")

# 추후 그래프 추가 예시 문구 자리
st.info("💡 **이 그래프로 알 수 있는 것:** (추가 예정 그래프에 대한 설명 문구가 들어갈 자리입니다.)")
